(function ($) {
	...
	$.fn.pixel = function (option) {
		...
		return this.each(function () {
			...
			$this.data('mark-layer-active', openLayer);
			$this.data('mark-item-active', markCarouselItemActive);
...
//							hash_layers[ld.name] = ld;
				...
				$this
					...
					function (e) {
						...
						if(carousel.find('.debug-item.layer-item-' + name).length) {
							return;
						}
					...
					function (e) {
						...
						for (layer in hash_layers) {
							...
							if(carousel_in.find('.debug-item.layer-item-' + layer + '.group-' + selected_group).length) {
								continue;
							}
